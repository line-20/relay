...
# Source: commands/explore.md · edit that file, then re-run the script.
name: rle
description: Short name for /relay:explore — turn a rough idea into a shaped brief on the board.

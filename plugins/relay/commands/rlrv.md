...
# Source: commands/review.md · edit that file, then re-run the script.
name: rlrv
description: Short name for /relay:review — domain specialists review a PR or the current branch, merged into one report.

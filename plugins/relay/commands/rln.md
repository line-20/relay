...
# Source: commands/next.md · edit that file, then re-run the script.
name: rln
description: Short name for /relay:next — a ranked shortlist from the board, then start the pick in a worktree.

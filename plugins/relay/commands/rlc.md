...
# Source: commands/continue.md · edit that file, then re-run the script.
name: rlc
description: Short name for /relay:continue — resume an in-flight thread from its handover.

...
# Source: commands/fix.md · edit that file, then re-run the script.
name: rlf
description: Short name for /relay:fix — re-verify the latest review's findings against the code, fix them, tick them off.

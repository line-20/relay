...
# Source: commands/ship.md · edit that file, then re-run the script.
name: rls
description: Short name for /relay:ship — the end-of-session loop: sync → test → PR → review → fix → merge → handover.

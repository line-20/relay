...
# Source: commands/refine.md · edit that file, then re-run the script.
name: rlrf
description: Short name for /relay:refine — ground a shaped brief against this project, into session-sized slices.
